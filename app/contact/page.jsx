      ...
      <div className="flex lg:justify-evenly sm:flex-col sm:text-sm">
        <form className="lg:w-2/3 sm:mb-10">
          <div className="flex flex-wrap sm:flex-col">
            <input className="bg-background border border-gray p-1 lg:mr-1 mb-2 lg:w-1/3 sm:w-full" type="text" name="" id="" placeholder="Name" />
            <input className="bg-background border border-gray p-1 lg:lg:mr-2 mb-2 lg:w-1/3 sm:w-full" type="text" name="" id="" placeholder="Email" />
            <input className="bg-background border border-gray p-1 lg:lg:mr-2 mb-2 lg:w-2/3 sm:w-full" type="text" name="" id="" placeholder="Title" />
